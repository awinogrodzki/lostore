...
var getResultFromAsyncReducer = function (state, reducerPromise) { return __awaiter(void 0, void 0, void 0, function () {
    var reducer, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, reducerPromise];
            case 1:
                reducer = _a.sent();
    ...
    var useStore = function () {
        ...
        var actions = Object.entries(reducers).reduce(function (actions, _a) {
            ...
            return (__assign(__assign({}, actions), (_b = {}, _b[actionType] = function () {
                ...
                var setStateIfChanged = function (value) {
                    if (value === state) {
                        return;
                    }
                    setState(value);
                ...
                if (reducer instanceof Promise) {
                    return getResultFromAsyncReducer(state, reducer).then(function (result) {
                        setStateIfChanged(result);
                    });
                }
                var result = reducer(state);
                if (result instanceof Promise) {
                    return result.then(function (value) { return setStateIfChanged(value); });
                }
                setStateIfChanged(result);
            }, _b)));
        }, {});
