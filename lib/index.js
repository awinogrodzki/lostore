...
exports.createHookStore = function (reducers, initialState, StoreContext, StoreProvider) {
    if (StoreContext === void 0) { StoreContext = context_1.createStoreContext(initialState); }
    if (StoreProvider === void 0) { StoreProvider = provider_1.createStoreProvider(StoreContext); }
